 ...
 * @author Chonghuan
 */
@WebServlet(name = "StudentUnfollowTeacher", urlPatterns = {"/student/unfollowteacher"})
public class StudentUnfollowTeacher extends HttpServlet 
{
    @Override
            ...
            throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            CheckResult result = query.unfollowTeacher(idModel);
