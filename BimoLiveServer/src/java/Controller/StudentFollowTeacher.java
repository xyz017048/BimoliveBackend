 ...
 * @author Chonghuan
 */
@WebServlet(name = "StudentFollowTeacher", urlPatterns = {"/student/followteacher"})
public class StudentFollowTeacher extends HttpServlet
{
    @Override
            ...
            throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            CheckResult result = query.followTeacher(idModel);
